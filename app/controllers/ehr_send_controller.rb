...
#       @ehrUrl = "http://hapi.fhir.org/baseR4"  # test HAPI FHIR server
#       @ehrUrl = "http://hospital-pseudo-ehr.herokuapp.com/api/v1" # pseudo-EHR
...
#        puts "Assessment QR JSON: #{@assessment.to_json}"
        ...
        sdcFile = "#{Rails.root}/public/datafiles/FASI-11.json"
